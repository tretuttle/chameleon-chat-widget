...
export const contactAgentFlow: ConversationFlow = {
  ...
  phone_call: {
    id: 'phone_call',
    botMessage: [
      "OK. Amigo agents are available by phone Monday through Friday from 7:30 a.m. to 5:30 p.m. EST.",
  ...
  enter_contact_info: {
    ...
    botMessage: [ "Please enter your name and phone number." ],
    userOptions: [],
    allowTextInput: true
  },
  ...
  send_email: {
    id: 'send_email',
    botMessage: [
      "OK. Please email service@myamigo.com with your name, company, phone number, and a brief description of what you need help with.",
